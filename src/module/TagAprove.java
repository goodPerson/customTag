...
public class TagAprove {
   
	
	private String tag_id;                       //申请单标识
	private String tag_name;                     //申请单名称
	private String tag_applyer;                  //申请人
	private String tag_applyer_id;               //申请人ID
	private String create_time;                   //标签创建时间
	private String tag_examiner;                 //审批人
	private String tag_examiner_id;              //审批ID
