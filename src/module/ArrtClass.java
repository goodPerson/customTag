 ...
 *
 */
public class ArrtClass {
	private String num_order; //属性Id
	private String attr_classify; //大类属性
	private String attr_classify_one; //二级属性
	private String attr_classify_two; //三级属性
