          ...
          <tr>
            ...
            <tr class="tag_info">
              <td colspan="3" height="20px" style="padding-left:10px;" >
                ...
                <div style="float:left;margin-left:5px;margin-right:5px">
                     <s:if test='title!=""'>
                      <input name="" id="tag_name_text" type="text"  value="<s:property value='title'/>" style="width:400px; height:25px; border:1px solid  #CCC;"onfocus="if (value =='请输入客户群名称'){value =''}" onBlur="if (value ==''){value='请输入客户群名称';}" onKeyDown="{this.style.color='#000'}" >
                     </s:if>
                     <s:else>
                      <input name="" id="tag_name_text" type="text"  value="请输入客户群名称" style="width:400px; height:25px; border:1px solid  #CCC;"onfocus="if (value =='请输入客户群名称'){value =''}" onBlur="if (value ==''){value='请输入客户群名称';}" onKeyDown="{this.style.color='#000'}" >
                     </s:else>
...
html_start="<div id='"+edit_tr+"' title='"+attrs_id+"_group' style='float:left;'>"
  +    "<div style='margin-left:5px;  margin-top:5px; width:675px;  border-top:1px solid #CCC;border-left:1px solid #CCC;border-right:1px solid #CCC; height:32px; line-height:32px;'>"
    ...
    */
    ...
    window.location.href="initBigClassName.action?title_name="+ encodeURI(encodeURI($("#tag_name_text").val())) +"&id=&userId="+userId+"&regionId="+regionId+"&href=&type=&tag_introduce="+encodeURI(encodeURI($("#tag_introduce").val()))+"&create_tag_date="+encodeURI(encodeURI($("#create_tag_date").combobox("getText")))+"&end_tag_date="+encodeURI(encodeURI($("#end_tag_date").combobox("getText")))+"&cityName="+encodeURI(encodeURI($("#cityName").combobox("getValue")))+"&countyName="+encodeURI(encodeURI($("#countyName").combobox("getValue")))+"&userState="+encodeURI(encodeURI($("#userState").combobox("getValue")))+"&count=";
    });
